...
export class NFTContract {
    ...
    /**
     * Search for all NFT Transfer events since {fromBlock} until the latest
     * @param fromBlock initial block of search
     * @returns Promise of events array
     */
    getTransferEvents(fromBlock: string | number): Promise<Array<Event>> {
        const filter = this.contract.filters.Transfer();
        return this.contract.queryFilter(filter, fromBlock, 'latest');
    }
}
